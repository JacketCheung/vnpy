...
if __name__ == '__main__':
    from vnpy.trader.app.ctaStrategy.strategy.strategyOne import OneStrategy
    
    # 创建回测引擎
    engine = BacktestingEngine()
    
    # 设置引擎的回测模式为K线
    engine.setBacktestingMode(engine.tick)
    ...
    # 设置使用的历史数据库
    engine.setDatabase(TICK_DB_NAME, 'lol000')
    
    # 在引擎中创建策略对象
    d = {}
    engine.initStrategy(OneStrategy, d)
